...
if __name__ == "__main__":
    ...
    print("R(B1), regardless of the conditional probability:", SSR[0][0])
    print("R(B2), regardless of the conditional probability:", SSR[0][1])
    print("R(B3), regardless of the conditional probability:", SSR[0][2])