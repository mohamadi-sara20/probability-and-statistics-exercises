...
if __name__ == "__main__":
    ...
    print("========================= Variance and Covariance of B1 and B11 =========================")
    A = var_covar_matrix(X=X_q)
    s = compute_s(X=X_q, y=y, b=b_q)
    print("B1 Var: ", A[1][1] * s)
    print("B11 Var: ", A[2][2] * s)
    print("B11 and B1 CoVar: ", A[1][2] * s)
